  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center p-8 md:p-16 bg-white text-gray-600">
      <div className="flex-1 max-w-2xl text-center md:text-left mb-8 md:mb-0">
        ...
        <h3 className="text-3xl font-light text-blue-400 mt-2">Desenvolvedor full stack | mobile | desktop</h3>
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-8 justify-center md:justify-start">
          <button className="cursor-pointer bg-blue-500 text-white py-3 px-8 rounded-full font-semibold hover:bg-blue-600 transition-colors shadow-lg">
            Vamos Conversar
          </button>
          <a
  ...
  >
    Baixar CV ↓
      ...
      <div className="flex-1 flex justify-center md:justify-end mt-8 md:mt-0">
        <div className="rounded-full overflow-hidden w-94 h-94 md:w-95 md:h-95 border-4 border-blue-300 shadow-xl">
          <Image
